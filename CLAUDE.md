...
| `/profile/:id` | `ProfileView` | Public profile. Avatar, bio, stats; **read-only** book collection with "Request to Borrow" (own profile is a preview — book CRUD lives in `/library`, not here) |
